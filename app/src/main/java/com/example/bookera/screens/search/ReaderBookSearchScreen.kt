package com.example.bookera.screens.search
...
fun SearchScreen(navController: NavController,
    ...
    Scaffold(topBar = {
       ...
       // navController.popBackStack()//move to prev screen
...
fun BookList(navController: NavController,
    ...
    if (viewModel.isLoading){
        ...
        LazyColumn(modifier = Modifier.fillMaxSize(),
            ...
            items(items = listOfBooks) { book -> //MBook(id = "dadfa", title = "Hello Again", authors = "All of us", notes = null)
...
fun BookRow(
    ...
    Card(modifier = Modifier
        .clickable {
            ...
            //when we click on the book row we show them the details of that book.
        }
        .fillMaxWidth()
        .height(100.dp)
        .padding(3.dp),
...
fun SearchForm(
    ...
    Column {
        ...
        val valid = remember(searchQueryState.value) {//to check if searched value is valid
            searchQueryState.value.trim().isNotEmpty()

        }

        InputField(valueState = searchQueryState,//input of search screen
            labelId = "Search",
            enabled = true,
