package com.example.bookera.screens.update
...
import com.example.bookera.components.InputField
import com.example.bookera.components.RatingBar
import com.example.bookera.components.ReaderAppBar
import com.example.bookera.components.RoundedButton
import com.example.bookera.components.showToast
...
import com.example.bookera.utils.formatDate
...
fun ShowSimpleForm(book: MBook,
    ...
    Row {
        ...
        val changedNotes = book.notes != notesText.value//check if notes changed
        val changedRating = book.rating?.toInt() != ratingVal.value//check if rating changed
...
@Composable
fun SimpleForm( //Enter your thoughts structure
